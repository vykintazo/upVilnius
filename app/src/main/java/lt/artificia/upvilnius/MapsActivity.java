...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBar.setIndicatorTextFormat("${PROGRESS}h");
        hours = findViewById(R.id.hoursSelected);
        hours.setText(String.valueOf(seekBar.getProgress()));
...
//                Log.i(TAG, seekParams.thumbPosition);
                hours.setText(String.valueOf(seekParams.progress));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent myIntent = new Intent(MapsActivity.this, CreateEvent.class);
    ...
    public void results(View v){
        Intent myIntent = new Intent(MapsActivity.this, ResultsActivity.class);
        MapsActivity.this.startActivity(myIntent);
    }
}
